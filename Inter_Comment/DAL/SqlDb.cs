...
namespace DAL
{
    public class SqlDb
    {
        ...
        public DataTable FillDt(string selectSql,SqlParameter[] paras)
        {
        ...
        /// </summary>
        /// <param name="strSql">sql语句</param>
        /// <param name="para">参数化对象</param>
        /// <returns></returns>
        public SqlDataReader GetDataReader_ZUO(string strSql, SqlParameter[] para)
        {
            conn.Close();
            conn.Open();
