...
function loaditems() {
    ...
    $.ajax({
        ...
        success: function (result) {
            document.getElementById('alter_select').innerHTML += result.d;
...
$.ajax({
    ...
    success: function (result) {
        ...
        document.getElementById('alter_theme').value = obj.theme;
        document.getElementById('alter_first').value = obj.first;
        document.getElementById('alter_second').value = obj.second;
        document.getElementById('alter_third').value = obj.third;
        document.getElementById('alter_forth').value = obj.forth;
        document.getElementById('alter_fifth').value = obj.fifth;
...
$.ajax({
    ...
    success: function (result) {
        var obj = eval("(" + result.d + ")");
        document.getElementById('alter_first_value').value = obj.first;
        document.getElementById('alter_second_value').value = obj.second;
        document.getElementById('alter_third_value').value = obj.third;
        document.getElementById('alter_forth_value').value = obj.forth;
        document.getElementById('alter_fifth_value').value = obj.fifth;
    },
    error: function (XMLHttpRequest, textStatus, errorThrown) {
        alert(XMLHttpRequest.status);
        alert(XMLHttpRequest.readyState);
